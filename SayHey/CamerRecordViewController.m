...
@property (strong,nonatomic) AVCaptureVideoDataOutput *captureVideoOutput;
...
@implementation CamerRecordViewController
...
//        AVCaptureConnection *captureConnection=[_captureMovieFileOutput connectionWithMediaType:AVMediaTypeVideo];
        ...
        AVCaptureConnection *captureConnection=[_captureVideoOutput connectionWithMediaType:AVMediaTypeVideo];
...
- (IBAction)takeButtonClick:(UIButton *)sender {
    ...
    //根据连接取得设备输出的数据
    dispatch_queue_t queue = dispatch_queue_create("videooutputQueue", NULL);
