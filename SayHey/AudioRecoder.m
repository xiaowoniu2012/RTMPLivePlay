...
//    fwrite(inBuffer->mAudioData, inBuffer->mAudioDataByteSize, 1, pfile);
...
//        mRecordFormat.mFormatFlags = kMPEG4Object_AAC_Main;
        ...
        mRecordFormat.mSampleRate = 22050;
    }
//    pfile = fopen("/Users/zouzelong/Desktop/FLV文件/sayhey.pcm", "wb");
    return self;
}
...
//                       NULL /* run loop */, NULL /* run loop mode */,
    ...
    for (i = 0; i < kNumberRecordBuffers; ++i) {
        stat = AudioQueueAllocateBuffer(mQueue, 2048, &mBuffers[i]);
