...
//    }
    ...
    if (isStartPub) {
        ...
        char *buffers = (char *)malloc(4096);
        encoder_pcm_to_aac(aacEncoder, audioBuffer, buffers);
        
        send_pkt(pPubRtmp,buffers, sizeof(buffers), RTMP_PACKET_TYPE_AUDIO, pubTs += 20);
        
//        send_pkt(pPubRtmp,audioBuffer, size, RTMP_PACKET_TYPE_AUDIO, pubTs += 20);
